...
| `app/about/page.tsx`    | Сторінка About |
...
- **Browse by property type** - вибір типу помешкання.
...
- **Book** - перейти на сторінку з детальною інформацією.
5. **Сторінка з детальною інформацією** 
...
- **sign up** - зареєструвати користувача.
- **Log out** - вийти з з облікового запису. 
...
- Логін
- Реєстрація
- Адміністративна панель (Dashboard, Rooms, Accommodations, Bookings)
