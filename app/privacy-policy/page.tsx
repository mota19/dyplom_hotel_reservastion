...
const PrivacyPolicy: FC = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to hotel_reservation.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to hotel_reservation, accessible
            from{" "}
            <a
              href="https://dyplom-hotel-reservastion.vercel.app/sign-in"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://dyplom-hotel-reservastion.vercel.app/sign-in
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mota82589@gmail.com</li>
      </ul>
    </>
  );
};
